...
function LayoutRoot({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("min-h-screen bg-gray-100", className)} data-slot="layout-root" {...props} />;
}

function LayoutHeader({ className, ...props }: React.ComponentProps<"header">) {
  return (
    <header
      className={cn("border-gray-700 border-b bg-gray-800 text-gray-100", className)}
...
function LayoutHeaderContent({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("px-6", className)} data-slot="layout-header-content" {...props} />;
}
...
function LayoutSidebar({ className, ...props }: React.ComponentProps<"aside">) {
  return (
    <aside
      className={cn("w-64 border-gray-300 border-r bg-gray-800 text-gray-100", className)}
...
function LayoutSidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return <div className={cn("border-gray-700 border-b p-4", className)} data-slot="layout-sidebar-header" {...props} />;
}
...
function LayoutMain({ className, ...props }: React.ComponentProps<"main">) {
  return <main className={cn("flex-1 overflow-y-auto bg-white", className)} data-slot="layout-main" {...props} />;
}
